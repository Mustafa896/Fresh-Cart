            ...
            <nav className='container d-flex justify-content-center' aria-label="Page navigation example">
                <ul className="pagination">
                    <li className="page-item">
                        <Link className="cursor-pointer page-link " to='/products' aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                        </Link>
                    </li>
                    <li className="page-item"><Link className="page-link cursor-pointer" to='/products' >1</Link></li>
                    <li className="page-item"><Link className="page-link cursor-pointer"  >2</Link></li>
                    <li className="page-item">
                        <Link className="cursor-pointer page-link" aria-label="Next">
